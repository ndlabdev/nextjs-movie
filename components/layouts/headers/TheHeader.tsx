    ...
    return (
        <div className="flex flex-col">
            <div className="bg-stone-600 text-white border-b h-16 py-2 border-none relative z-10 w-full flex-shrink-0">
                <div className="flex h-full items-center justify-end gap-3 pl-3 pr-2 md:pl-4 md:pr-4">
                    <Link className="block flex-shrink-0 mr-1 md:mr-6 h-full max-h-7 md:max-h-9 font-semibold md:mt-1" href='/'>
                        <Image
                            alt='logo'
                            className='w-full'
                            height={60}
